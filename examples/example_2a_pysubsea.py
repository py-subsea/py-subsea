...
def data():
    ...
    """
    # Import design data
    dfr = pd.read_excel('example_2a.xlsx', sheet_name='Example2a-Route')
    dfs = pd.read_excel('example_2a.xlsx', sheet_name='Example2a-Survey')
    dfs = dfs.loc[
...
def plot2(df):
    ...
    try:
        ...
        try:
            ...
            pass  # If backend does not support maximising
    plt.savefig('example_2a_plot2.png', dpi=300, bbox_inches='tight')
...
def plot5(df1, df2):
    ...
    try:
        ...
        try:
            ...
            pass  # If backend does not support maximising
    plt.savefig('example_2a_plot5.png', dpi=300, bbox_inches='tight')
    plt.show()
